...
if (isset($_POST['submit'])) {
  ...
  $time1=$_POST['1time'];
    ...
    if (!$run) {
      ...
      $msg=1;
       header("Location:c-event-schedule-view.php");
    }
...
<h2>Edit Conference Event Time Schedule</h2>
