...
<div class="page-wrapper">
            <div class="content">
                        ...
                        <h4 class="page-title">View ContactUs</h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <tr>
                        ...
                        <td><center>
                          <a href="contactus-del.php?id=<?php echo $id ?>"><input type="submit" class="btn  btn-sm" value="Delete" name="" style="background-image: linear-gradient(120deg, #ee8425 0%, #f9488b 100%), linear-gradient(120deg, #ee8425 0%, #f9488b 100%);color: white"></a></center></td>
                      </tr>
