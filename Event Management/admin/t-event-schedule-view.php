...
<div class="page-wrapper">
            <div class="content">
                        ...
                        <h4 class="page-title">Technology Event Schedule</h4>
                        <?php
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <tr>
                        ...
                        <td><center><a href="t-event-schedule-edit.php?id=<?php  echo $id ?>"><input type="submit" class="btn btn-sm" value="Edit" name="" style="background-image: linear-gradient(120deg, #2547ee 0%, #e7e9e5 100%), linear-gradient(120deg, #ee8425 0%, #f9488b 100%);color: white;"></a>
                          <a href="t-event-schedule-del.php?id=<?php echo $id ?>"><input type="submit" class="btn  btn-sm" value="Delete" name="" style="background-image: linear-gradient(120deg, #ee8425 0%, #f9488b 100%), linear-gradient(120deg, #ee8425 0%, #f9488b 100%);color: white"></a></center></td>
                      </tr>
