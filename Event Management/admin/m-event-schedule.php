...
if(isset($_POST['submit']))
{
                ...
                if ($time1=="")
                  ...
                  $query="INSERT INTO `m-schedule`(`1time`,`2time`,`3time`,`4time`,`date1`,`date2`,`date3`,`date4`,`d1event1`,`d1event2`,`d1event3`,`d1event4`,`d2event1`,`d2event2`,`d2event3`,`d2event4`,`d3event1`,`d3event2`,`d3event3`,`d3event4`,`d4event1`,`d4event2`,`d4event3`,`d4event4`) VALUES ('$time1','$time2','$time3','$time4','$date1','$date2','$date3','$date4','$d1event1','$d1event2','$d1event3','$d1event4','$d2event1','$d2event2','$d2event3','$d2event4','$d3event1','$d3event2','$d3event3','$d3event4','$d4event1','$d4event2','$d4event3','$d4event4')";
