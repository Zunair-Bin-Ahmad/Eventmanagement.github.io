...
if (isset($_POST['submit'])) {
  ...
  $heading=$_POST['heading'];
     ...
     $query="UPDATE `eventtime` SET `heading`='$heading',`days`='$days',`hours`='$hours',`minutes`='$minutes',`sec`='$sec' WHERE id='$id'";
    ...
    if (!$run) {
      ...
      $msg=1;
       header("Location:eventtime-view.php");
    }
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2"> 
                        <h4 class="page-title">Edit Event Time</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
...
<input type="number" class="form-control" value="<?php echo $row['days'] ?>" name="days">
</div>
<div class="form-group">
  <label for="password-1">Hours</label>
<input type="number" class="form-control" value="<?php echo $row['hours'] ?>" name="hours">
</div>
<div class="form-group">
  <label for="password-1">Minutes</label>
<input type="number" class="form-control" value="<?php echo $row['minutes'] ?>" name="minutes">
</div>
<div class="form-group">
  <label for="password-1">Sec</label>
<input type="number" class="form-control" value="<?php echo $row['sec'] ?>" name="sec">
</div>
<div class="form-group">
