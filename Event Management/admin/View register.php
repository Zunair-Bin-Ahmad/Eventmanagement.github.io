...
<div class="page-wrapper">
            <div class="content">
                        ...
                        <h4 class="page-title">View Register</h4>
                ...
                <div class="row">
                  ...
                  $tests=$row['Tests'];
                      ...
                      <tr>
                        ...
                        <td><center><a href="../user/edit register.php?id=<?php  echo $id ?>"><input type="submit" class="btn btn-success btn-sm" value="Edit" name=""></a>
                          <a href="delete register.php?id=<?php  echo $id ?>"><input type="submit" class="btn btn-danger btn-sm" value="Delete" name=""></td></a></center></td>
                      </tr>
                      <?php
