...
if (isset($_POST['submit'])) {
  ...
  $time1=$_POST['1time'];
    ...
    if (!$run) {
      ...
      $msg=1;
       header("Location:t-event-schedule-view.php");
    }
...
<h2>Edit Technolog Event Time Schedule</h2>
